...
const announcements = [
  ...
  },
  {
    ...
    content: "We will have a guest lecture by Dr. Emily Chen on 'Modern Software Architecture' on June 20th at 2 PM in Hall A. Dr. Chen is a renowned expert in cloud-native architectures and has worked with several Fortune 500 companies. This lecture will provide valuable insights into current industry practices and future trends. Attendance is highly recommended for all students, as the concepts discussed will be relevant to your final projects. There will be a Q&A session following the lecture, so come prepared with your questions!",
    date: "2023-06-12",
  ...
  },
  {
    ...
    content: "Due to unforeseen circumstances, the midterm exam for Physics 101 has been rescheduled to June 25th at 10 AM in Hall C. We apologize for any inconvenience caused and encourage you to use this extra time to review the material. Please reach out if you need any further clarifications on the exam topics.",
    date: "2023-06-10",
    author: "Prof. Davis"
  },
  {
    ...
    content: "The campus cafeteria will undergo renovations starting on June 22nd and will remain closed until July 1st. During this time, food services will be available at the temporary food trucks stationed outside the Student Center. We appreciate your patience during the construction period and look forward to unveiling the new and improved cafeteria!",
    date: "2023-06-09",
  ...
  },
  {
    ...
    content: "The lab schedule for BIO301 has been updated. Starting June 18th, labs will be held on Wednesdays and Fridays from 1 PM to 4 PM in Lab 5B. Please make sure to review the updated schedule on the course portal and plan accordingly. Attendance is mandatory, and lab assignments will be graded.",
    date: "2023-06-08",
    author: "Prof. Carter"
  },
  {
  ...
  },
  {
    ...
    content: "Please be reminded that the final essay for English 102 must be submitted via the course portal by June 20th, 11:59 PM. Late submissions will not be accepted. Make sure to follow the provided guidelines, including proper citation format and word count. If you have any questions, reach out to your TA or schedule a meeting during office hours.",
    date: "2023-06-06",
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <Avatar>
                  <AvatarImage src={`https://api.dicebear.com/6.x/initials/svg?seed=${announcement.author}`} />
                  <AvatarFallback>{announcement.author[0]}</AvatarFallback>
                </Avatar>
                <div className="flex-grow">
                  <CardTitle className="text-lg">{announcement.title}</CardTitle>
                  <CardDescription>{announcement.author} • {announcement.date}</CardDescription>
                </div>
              </div>
              <div className="flex items-center space-x-2 flex-shrink-0">
                {announcement.type === "overall" ? (
                  ...
                  <div className="text-sm font-medium text-blue-600">{announcement.courseCode}</div>
                )}
                {isOpen ? (
